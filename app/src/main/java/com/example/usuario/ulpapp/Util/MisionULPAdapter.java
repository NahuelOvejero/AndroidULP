...
public class MisionULPAdapter {
    private static final String NAME="MisionULP";
    private SQLiteDatabase sqlDB;
    public MisionULPAdapter(SQLiteDatabase sqlDB){
        this.sqlDB=sqlDB;
    }
    private class Columns implements BaseColumns {
        public final static String _ID="Id_Mision";
    ...
    public boolean insert (int IdMision,String descr){
        ContentValues valores=new ContentValues();
        valores.put(Columns._ID,IdMision);
